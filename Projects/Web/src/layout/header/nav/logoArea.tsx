        ...
        return (
            <Link href={siteLinks.home.href} className='group select-none'>
                <span className='flex flex-col items-center justify-center leading-tight'>
                    <span className='clamp-[text,md,lg,@md,@2xl] flex flex-row gap-1 font-extrabold'>
                    ...
                    <span className='clamp-[text,md,lg,@md,@2xl] text-secondary drop-shadow-[0_0_8px_theme(colors.secondary.DEFAULT)/80] mt-0.5 font-extrabold'>
                        Insights
                    </span>
                </span>
            </Link>
